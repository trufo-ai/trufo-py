...
from trufo.api.tps.sign_c2pa import sign_c2pa_distributed, sign_c2pa_distributed_test

__version__ = "0.4.0"

__all__ = ["__version__", "sign_c2pa_distributed", "sign_c2pa_distributed_test"]
