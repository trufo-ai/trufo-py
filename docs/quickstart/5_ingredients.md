...
Three relationships are available today; entries may optionally carry base64 `media`, which is hashed and thumbnailed (and validated when it carries its own C2PA manifest):
